...
export function useTodosLosEquipos(filtros: FiltrosEquipos = {}, habilitado = true) {
  return useQuery({
    queryKey: ['equipos', 'todos', filtros] as const,
    queryFn: () => obtenerTodosLosEquipos(filtros),
    enabled: habilitado,
  });
}
